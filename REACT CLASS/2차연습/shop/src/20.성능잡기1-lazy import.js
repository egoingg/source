...
import './App.css';
import React, { useContext, useEffect, useState, lazy, Suspense } from 'react'; //step1. react 라이브러리에서 lazy, Suspense를 import 해오시고
...
//======================================================================================
//제목:lazy import 하는법 & React Dev Tools 구글검색해서 설치
//당장 필요없는 컴포넌트들은 나중에 필요할때 import 해주세요 이 기능

//step1. react 라이브러리에서 lazy, Suspense를 import 해오시고
