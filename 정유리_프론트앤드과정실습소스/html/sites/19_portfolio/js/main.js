$(document).ready(function(){
    ...
    var videoH = $('.slider').height(); //$('#videoBg').height(); //동영상의 세로 길이
    ...
    if (wwidth < 768){ //모바일 크기일때는 - 부모 s1 높이를 동영상의 세로 크기 기준으로 맞춤
        ...
        $('.sl1').css('height',wheight);
        $('.sl2').css('height',wheight);
        $('.sl3').css('height',wheight);
        
        console.log("#s1 height?" + wheight);
    }
    ...
    $('.nav li a').on('click', function(e){
        ...
        console.log(ttt + $(ttt).offset().top);
    });
